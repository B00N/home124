...
function h124_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['#attached']['library'][] = 'h124/theme-settings';
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['breadcrumb_separator'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumb_separator', 'h124'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['scrolltop']['scrolltop_display'] = array(
    ...
    '#default_value' => theme_get_setting('scrolltop_display', 'h124'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['scrolltop']['scrolltop_icon'] = array(
    ...
    '#default_value' => theme_get_setting('scrolltop_icon','h124'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['header']['fixed_header'] = array(
    ...
    '#default_value' => theme_get_setting('fixed_header', 'h124'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['bootstrap_tab']['bootstrap']['bootstrap_remote_type'] = array(
    ...
    '#description'   => t('From the drop down select box, select how to load the Bootstrap library. If you select "Local" make sure that you download and place Bootstrap folder into the root theme folder (h124/bootstrap).'),
    '#default_value' => theme_get_setting('bootstrap_remote_type', 'h124'),
    '#options' => array(
